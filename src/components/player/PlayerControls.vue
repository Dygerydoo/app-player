<template>
  <div class="app-PlayerControls">
    <button class="app-Buttons_Primary-flatRounded" @click="prevTrack"><i class="material-icons">skip_previous</i></button>
    ...
    <button class="app-Buttons_Primary-flatRounded" @click="nextTrack"><i class="material-icons">skip_next</i></button>
  </div>
</template>
